  ...
  <ul class="nav navbar-nav nav nav-pills pull-right">
    ...
    <!-- <li role="presentation" class="dropdown">
      <a class="dropdown-toggle" data-toggle="dropdown" href="Logout" role="button" aria-expanded="false">
        ...
        <li role="presentation" class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="Logout" role="button" aria-expanded="false">
            <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Prestamos 
            <span class="caret"></span>
          </a>
          <ul class="dropdown-menu" role="menu">
            <li role="presentation">
              <a role="menuitem" href="loanapplications">
                Solicitudes nuevas
              </a>
            </li>
            <li role="presentation">
              <a role="menuitem" href="approvedloans">
                Solicitudes aprobadas
              </a>
            </li>
            <li role="presentation">
              <a role="menuitem" href="deniedloans">
