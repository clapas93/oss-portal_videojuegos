        ...
        <ul class="nav navbar-nav nav nav-pills pull-right">
          <li role="presentation" class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li role="presentation"><a role="menuitem" tabindex="-1" href="ManageGamesHI.jsp">Videojuegos</a></li>
            ...
            <table class="table table-striped table-bordered table-hover table-condensed">
              ...
              <tbody>
                <tr>
                  ...
                  <td>30</td>
                  <td>
                    <a href="EditarJuego.jsp" class="btn btn-primary" type="button">Editar</a>
                    <br><br>
                    <button class="btn btn-primary btn btn-danger" type="button">Eliminar</button>
                  </td>
                </tr>
              </tbody>
            </table>
